...
def ReadData(data):
	...
	if teamAScore > 16 or teamBScore > 16:	# overtimes are considered ties
		...
		actualScoreA = float(teamAScore) / float(teamAScore + teamBScore) + param2
		actualScoreB = 1 - actualScoreA
	elif teamBScore > teamAScore:
		actualScoreB = float(teamBScore) / float(teamAScore + teamBScore) + param2
